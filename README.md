...
<table>
  ...
  <tr>
    <td>| <code>Version:D</code> | This is the version of this | | specification, <code>v0.7.Draft</code>.</td>
  </tr>
  <tr>
    <td>| <code>Supplier:D</code> | The error stream for logging.</td>
  </tr>
  <tr>
    <td>| <code>Bool:D</code> | True if the app may be | | simultaneously invoked in another | | thread in the same | | process.</td>
  </tr>
  <tr>
    <td>| <code>Bool:D</code> | True if the app may be simultaneously | | invoked in another process.</td>
  </tr>
  <tr>
    <td>| <code>Bool:D</code> | True if the server expects the app | | to be invoked only once during the | | life of the process. This is not a | | guarantee.</td>
  </tr>
  <tr>
    <td>| <code>Set:D</code> | This is a <a href="http://doc.perl6.org/type/Set">Set</a> of strings naming the | | protocols supported by the application | | server.</td>
  </tr>
  <tr>
    <td>| <code>SetHash:D</code> | This is a mutable set of strings | | naming the actual protocols to be | | used by the application server. This | | SHOULD be modified by the application | | to only include those protocols | | supported. The values of this set and | | any changes made during the | | application lifecycle MUST be | | preserved for the lifetime of the | | application.</td>
  </tr>
</table>
